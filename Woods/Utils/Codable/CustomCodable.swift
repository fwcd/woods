...
/// ```
@propertyWrapper
struct CustomCodable<CustomCoder: CustomCodableWrapper> {
    typealias CustomCoder = CustomCoder

    /// The underlying value.
    var wrappedValue: CustomCoder.Wrapped

    init(wrappedValue: CustomCoder.Wrapped) {
...
extension CustomCodable: Equatable where CustomCoder.Wrapped: Equatable {}
extension CustomCodable: Hashable where CustomCoder.Wrapped: Hashable {}
